...
function FormContribuye({ onClickActive,setActive }) {
    ...
    const validationSchema = Yup.object({
        cardNumber: Yup.number("deben ser números").required("Por favor, ingresa el numero de tarjeta"),

    });


    const styles = {
        input: 'border-solid rounded-md border-2 h-8 border-teal-500 bg-zinc-100 px-4 py-2 my-2'
    }
        ...
        <div>
            ...
            >
                ...
                {({ values, errors, touched, isSubmitting, setFieldValue, setFieldError }) => (
                    <Form id="form-checkout" className='flex flex-col max-w-xs	' onChange={handleInputChange} onFocus={handleInputFocus} >
                        ...
                        <div className="form-control">
                            ...
                            <SendButton text={"Aportar"}  id="form-checkout__submit">
