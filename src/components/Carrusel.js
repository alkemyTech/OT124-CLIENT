...
function Carrusel() {
  const styles = {
    ...
    carouselLabel:
      "z-10 inline rounded-md text-white px-5 py-3 bg-[rgb(0,0,0,0.6)] transition-all hover:bg-[rgb(0,0,0,1)]",
    prevArrow:
      "absolute flex justify-center items-center h-12 w-12 z-10 cursor-pointer text-5xl text-white transition-all duration-200 rounded-full top-[50%] left-[5%] bg-[rgb(0,0,0,0.1)] hover:bg-[rgb(0,0,0,1)]",
    nextArrow:
      "absolute flex justify-center items-center h-12 w-12 z-10 cursor-pointer text-5xl text-white transition-all duration-200 rounded-full top-[50%] right-[5%] bg-[rgb(0,0,0,0.1)] hover:bg-[rgb(0,0,0,1)]",
  };
