                        ...
                        return(
                            ...
                            my-4 md:mx-6 md:my-6  md:h-60 border-1 rounded-lg p-2 md:p-6 shadow-lg hover:shadow-2xl">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <button className="bg-red-500 w-fit self-center py-1 justify-self-center hover:bg-red-700 text-white font-bold text-xs md:text-sm px-2 md:px-4 rounded"
                                     id={element.id}
                                     onClick={(e) => deleteSubmit(e)}>Eliminar</button>
                                </div>
                            </div>)
                } )
                 :
